...
// recharts 3 narrowed its exported Tooltip/Legend prop types, so we describe the
// payload shape we actually read instead of deriving from the library types.
